...
class WpServio_Dashboard {
    ...
    public static function enqueue_admin_assets( string $hook ): void {
        if ( strpos( $hook, 'wpservio' ) === false ) {
            return;
        }
        if ( ! wp_script_is( 'wpservio-admin-js', 'registered' ) ) {
            wp_register_script( 'wpservio-admin-js', false, [ 'jquery' ], WPSERVIO_VERSION, true ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
        }
        wp_enqueue_script( 'wpservio-admin-js' );
        ...
        wp_add_inline_script( 'wpservio-admin-js', '
    ...
    public static function add_menu(): void {
        $icon_svg = file_get_contents( WPSERVIO_PLUGIN_DIR . 'assets/img/icon.svg' );
        $icon_url = 'data:image/svg+xml;base64,' . base64_encode( $icon_svg );

        add_menu_page(
            __( 'WpServio', 'wpservio' ),
            __( 'WpServio', 'wpservio' ),
            'manage_options',
            'wpservio',
    ...
    private static function get_stats(): array {
        ...
        $order_table = WpServio_Orders::table_name();
        ...
        // Stats factures
        $inv_table = WpServio_Invoices::invoices_table_name();
    ...
    public static function render_dashboard(): void {
        ...
        <div class="wrap serviceflow-dashboard">
            <h1 style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
                ...
                <?php esc_html_e( 'WpServio — Tableau de bord', 'wpservio' ); ?>
            ...
            <div class="serviceflow-stats">
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'Commandes totales', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'En attente', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'En cours', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'Terminées / Acceptées', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'Conversations', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'Total facturé', 'wpservio' ); ?></div>
                    </div>
                </div>
                <div class="serviceflow-stat-card">
                    <div class="serviceflow-stat-icon" style="background:#f59e0b">
                    ...
                    <div>
                        ...
                        <div class="serviceflow-stat-label"><?php esc_html_e( 'Factures à valider', 'wpservio' ); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="serviceflow-section">
                <h2 class="serviceflow-section-title">
                    ...
                    <?php esc_html_e( 'Commandes récentes', 'wpservio' ); ?>
                </h2>
                <table>
                    <thead>
                        <tr>
                            <th><?php esc_html_e( 'N°', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Client', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Service', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Statut', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Prix', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Délai', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Date', 'wpservio' ); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if ( empty( $orders ) ) : ?>
                            <tr class="serviceflow-empty-row"><td colspan="7"><?php esc_html_e( 'Aucune commande.', 'wpservio' ); ?></td></tr>
                        <?php else : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ( ! empty( $o->payment_mode ) && $o->payment_mode !== 'single' ) : ?>
                                        <span style="display:inline-block;margin-left:4px;padding:1px 5px;border-radius:4px;font-size:10px;font-weight:600;color:#fff;background:#f59e0b" title="<?php esc_attr_e( 'Paiement en plusieurs fois', 'wpservio' ); ?>">
                                            <?php echo match ( $o->payment_mode ) {
                                                'deposit'      => esc_html__( 'Acompte', 'wpservio' ),
                                                'installments' => esc_html__( 'Mensualités', 'wpservio' ),
                                                'monthly'      => esc_html__( 'Abonnement', 'wpservio' ),
                                                default        => esc_html( $o->payment_mode ),
                                            }; ?>
                                        </span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo esc_html( $o->total_delay ); ?> <?php esc_html_e( 'j', 'wpservio' ); ?></td>
            ...
            <div class="serviceflow-section">
                <h2 class="serviceflow-section-title">
                    ...
                    <?php esc_html_e( 'Activité récente', 'wpservio' ); ?>
                </h2>
                <table>
                    <thead>
                        <tr>
                            <th><?php esc_html_e( 'Utilisateur', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Service', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Message', 'wpservio' ); ?></th>
                            <th><?php esc_html_e( 'Date', 'wpservio' ); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if ( empty( $messages ) ) : ?>
                            <tr class="serviceflow-empty-row"><td colspan="4"><?php esc_html_e( 'Aucun message.', 'wpservio' ); ?></td></tr>
                        <?php else : ?>
    ...
    public static function render_shortcodes(): void {
        ...
        $main_shortcodes = [
            [
                'code'  => '[wpservio_options]',
                'title' => __( 'Options & Commande de service', 'wpservio' ),
                'desc'  => __( 'Affiche la carte de sélection des packs et options pour un service. Permet au client de choisir un pack, cocher des options et passer commande via le chat. À placer sur les pages du CPT configuré.', 'wpservio' ),
                'where' => __( 'Page single du CPT (template Elementor du service)', 'wpservio' ),
                'icon'  => 'dashicons-cart',
                'color' => '#6366f1',
            ],
            [
                'code'  => '[wpservio_account]',
                'title' => __( 'Widget Compte (Avatar / Connexion)', 'wpservio' ),
                'desc'  => __( 'Affiche un bouton « Se connecter / S\'inscrire » si l\'utilisateur n\'est pas connecté, ou son avatar avec un menu déroulant (Mon compte, Mes commandes, Se déconnecter) s\'il est connecté. Idéal pour le header.', 'wpservio' ),
                'where' => __( 'Header du site (widget Elementor, barre de navigation)', 'wpservio' ),
                'icon'  => 'dashicons-admin-users',
                'color' => '#3b82f6',
            ],
            [
                'code'  => '[wpservio_my_account]',
                'title' => __( 'Page Mon Compte', 'wpservio' ),
                'desc'  => __( 'Affiche la page complète du compte utilisateur avec deux onglets : « Mes commandes » (historique filtrable par statut) et « Mon profil » (informations personnelles). Redirige vers la connexion si non connecté.', 'wpservio' ),
                'where' => __( 'Page dédiée « Mon compte »', 'wpservio' ),
                'icon'  => 'dashicons-id-alt',
                'color' => '#10b981',
            ],
            [
                'code'  => '[wpservio_notifications]',
                'title' => __( 'Cloche de notifications', 'wpservio' ),
                'desc'  => __( 'Affiche une icône de cloche avec le compteur de notifications non lues. Au clic, un menu déroulant affiche les dernières notifications (nouveaux messages, commandes, changements de statut). Masqué si l\'utilisateur n\'est pas connecté.', 'wpservio' ),
                'where' => __( 'Header du site (barre de navigation, à côté du widget compte)', 'wpservio' ),
                'icon'  => 'dashicons-bell',
                'color' => '#ef4444',
            ],
        ];
        ...
        $field_sections = [
            [
                'title' => __( 'Packs', 'wpservio' ),
                'icon'  => 'dashicons-archive',
                'color' => '#6366f1',
                'desc'  => __( 'Affichent les données d\'un pack par son index (0 = premier). Attributs communs : index="0" post_id="".', 'wpservio' ),
                'fields' => [
                    [ 'code' => '[sf_pack_name index="0"]',          'label' => __( 'Nom du pack', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_price index="0" currency="€"]',  'label' => __( 'Prix du pack', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_starting_price currency="€"]',    'label' => __( 'Prix de départ (minimum des packs)', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_delay index="0" suffix=" jour(s)"]', 'label' => __( 'Délai de livraison', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_description index="0"]',   'label' => __( 'Description / infobulle', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_features index="0" format="list"]', 'label' => __( 'Caractéristiques (format="list" ou "inline")', 'wpservio' ) ],
                    [ 'code' => '[sf_pack_count]',                    'label' => __( 'Nombre total de packs', 'wpservio' ) ],
                ],
            ],
            [
                'title' => __( 'Options supplémentaires', 'wpservio' ),
                'icon'  => 'dashicons-plus-alt',
                'color' => '#f59e0b',
                'desc'  => __( 'Affichent les données d\'une option par son index (0 = première). Attributs communs : index="0" post_id="".', 'wpservio' ),
                'fields' => [
                    [ 'code' => '[sf_option_name index="0"]',         'label' => __( 'Nom de l\'option', 'wpservio' ) ],
                    [ 'code' => '[sf_option_price index="0" currency="€"]', 'label' => __( 'Prix de l\'option', 'wpservio' ) ],
                    [ 'code' => '[sf_option_delay index="0" suffix=" jour(s)"]', 'label' => __( 'Délai de l\'option', 'wpservio' ) ],
                    [ 'code' => '[sf_option_description index="0"]',  'label' => __( 'Description de l\'option', 'wpservio' ) ],
                    [ 'code' => '[sf_option_count]',                   'label' => __( 'Nombre total d\'options', 'wpservio' ) ],
                ],
            ],
            [
                'title' => __( 'Prix avancés', 'wpservio' ),
                'icon'  => 'dashicons-tag',
                'color' => '#10b981',
                'desc'  => __( 'Options tarifaires avancées (Premium). Attributs : currency="€" post_id="".', 'wpservio' ),
                'fields' => [
                    [ 'code' => '[sf_extra_page_price currency="€"]',  'label' => __( 'Prix page supplémentaire', 'wpservio' ) ],
                    [ 'code' => '[sf_maintenance_price currency="€"]', 'label' => __( 'Prix maintenance mensuelle', 'wpservio' ) ],
                    [ 'code' => '[sf_express_price currency="€"]',     'label' => __( 'Prix livraison express (par jour)', 'wpservio' ) ],
                ],
            ],
        ];
        ?>
        <div class="wrap serviceflow-dashboard">
            <h1 style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
                ...
                <?php esc_html_e( 'WpServio — Shortcodes', 'wpservio' ); ?>
            </h1>
            <p style="font-size:14px;color:#666;margin:0 0 28px 0">
                <?php esc_html_e( 'Copiez un shortcode et collez-le dans n\'importe quelle page, article ou widget Elementor.', 'wpservio' ); ?>
            </p>

            <!-- Shortcodes principaux -->
            <p class="serviceflow-sc-section-heading"><?php esc_html_e( 'Shortcodes principaux', 'wpservio' ); ?></p>
            <div class="serviceflow-sc-list">
                ...
                <div class="serviceflow-sc-card">
                    ...
                    <div class="serviceflow-sc-card-body">
                        ...
                        <div class="serviceflow-sc-card-code" onclick="serviceflowCopySC(this)" title="<?php esc_attr_e( 'Cliquer pour copier', 'wpservio' ); ?>">
                            <span class="dashicons dashicons-clipboard"></span>
                            <span class="serviceflow-sc-code-text"><?php echo esc_html( $sc['code'] ); ?></span>
                            <span class="serviceflow-sc-copied"><?php esc_html_e( 'Copié !', 'wpservio' ); ?></span>
                        </div>
            ...
            <!-- Champs dynamiques -->
            <p class="serviceflow-sc-section-heading"><?php esc_html_e( 'Champs dynamiques (Dynamic Tags)', 'wpservio' ); ?></p>
            <p style="font-size:13px;color:#666;margin:-4px 0 14px 0"><?php esc_html_e( 'À utiliser dans les templates Elementor des pages de service. Tous acceptent un attribut post_id="123" optionnel.', 'wpservio' ); ?></p>
            <div class="serviceflow-sc-list">
                ...
                <div class="serviceflow-sc-section">
                    ...
                    <div class="serviceflow-sc-fields">
                        ...
                        <div class="serviceflow-sc-field-row">
                            ...
                            <div class="serviceflow-sc-field-code" onclick="serviceflowCopySC(this)" title="<?php esc_attr_e( 'Cliquer pour copier', 'wpservio' ); ?>">
                                <span class="dashicons dashicons-clipboard"></span>
